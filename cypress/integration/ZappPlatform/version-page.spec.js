  ...
  describe('Zapp Page', () => {
    ...
    describe('Zapp versions', () => {
      it('Verify the app versions', () => {
        ...
        //version table
        cy.get('table[class="table table-hover table-striped middle-vertical-aligned"]').find('tr').should('have.length', 6)
        // Verify version of app
        cy.get('a[data-title="Version ID"]').first().contains('0.3')
